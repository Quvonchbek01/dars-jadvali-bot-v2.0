...
async def cmd_start(msg: Message, state: FSMContext):
    ...
    await msg.answer(
        ...
        f"⏰ <i>Kunlik dars jadvallaridan boxabar bo'lish uchun 'Eslatma' funksiyasidan foydalaning.</i>", reply_markup=main_menu()
    )
...
async def handle_rating(cb: CallbackQuery, state: FSMContext):
    ...
    await cb.message.edit_text(
        ...
        f"<i>Sizga botimizdagi nima yoqdi, yoki yoqmadi?</i>",
